  ...
  return (
    <UserLayout>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
        ...
        <h1 style={{ fontSize: 20, fontWeight: 700 }}>Edit Issue</h1>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div>
          ...
          <input className={`input-field ${errors.batch ? 'input-error' : ''}`} type="text"
            placeholder={isBatchRequired ? 'Contoh: BM13B' : 'Isi jika diketahui'}
            value={form.batch} onChange={(e) => handleChange('batch', e.target.value.toUpperCase())} />
        ...
        <div>
          ...
          <input className="input-field" type="text"
            value={form.storage_tujuan} onChange={(e) => handleChange('storage_tujuan', e.target.value)} />
        </div>
        <div style={{ height: 80 }} />
      </form>
